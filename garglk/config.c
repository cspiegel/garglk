...
style_t gli_tstyles[style_NUMSTYLES] =
{
    ...
    {PROPI, {0xff,0xff,0xff}, {0x00,0x00,0x00}, 0}, /* Note */
    {PROPR, {0xff,0xff,0xff}, {0x00,0x00,0x00}, 0}, /* BlockQuote */
    {PROPB, {0xff,0xff,0xff}, {0x00,0x60,0x00}, 0}, /* Input */
    {PROPR, {0xff,0xff,0xff}, {0x00,0x00,0x00}, 0}, /* User1 */
    {PROPR, {0xff,0xff,0xff}, {0x00,0x00,0x00}, 0}, /* User2 */
};
...
style_t gli_gstyles[style_NUMSTYLES] =
{
    ...
    {MONOZ, {0xff,0xff,0xff}, {0x60,0x60,0x60}, 0}, /* Alert */
    {MONOI, {0xff,0xff,0xff}, {0x60,0x60,0x60}, 0}, /* Note */
    {MONOR, {0xff,0xff,0xff}, {0x60,0x60,0x60}, 0}, /* BlockQuote */
    {MONOZ, {0xff,0xff,0xff}, {0x60,0x60,0x60}, 0}, /* Input */
