...
std::array<style_t, style_NUMSTYLES> gli_tstyles{{
    {FontFace::PropR, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* Normal */
    {FontFace::PropI, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* Emphasized */
    {FontFace::MonoR, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* Preformatted */
    {FontFace::PropB, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* Header */
    {FontFace::PropB, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* Subheader */
    {FontFace::PropZ, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* Alert */
    {FontFace::PropI, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* Note */
    {FontFace::PropR, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* BlockQuote */
    {FontFace::PropB, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* Input */
    {FontFace::PropR, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* User1 */
    {FontFace::PropR, {0xff,0xff,0xff}, {0x00,0x00,0x00}, false}, /* User2 */
}};

std::array<style_t, style_NUMSTYLES> gli_gstyles{{
    {FontFace::MonoR, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* Normal */
    {FontFace::MonoI, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* Emphasized */
    {FontFace::MonoR, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* Preformatted */
    {FontFace::MonoB, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* Header */
    {FontFace::MonoB, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* Subheader */
    {FontFace::MonoZ, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* Alert */
    {FontFace::MonoI, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* Note */
    {FontFace::MonoR, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* BlockQuote */
    {FontFace::MonoB, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* Input */
    {FontFace::MonoR, {0xff,0xff,0xff}, {0x60,0x60,0x60}, false}, /* User1 */
